      ...
      <div className="w-full bg-white rounded-3xl shadow-[0px_10px_30px_-5px_rgba(0,0,0,0.08)] border border-gray-100 flex flex-col overflow-hidden">
        ...
        <div className="w-full px-6 md:px-10 py-8 border-b border-gray-100 flex flex-col gap-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-400 text-sm md:text-base font-normal tracking-wide uppercase">{t('nuxio', 'ts_badge')}</span>
          </div>
          <h2 className="text-gray-900 text-2xl md:text-3xl font-semibold">{t('nuxio', 'ts_title')}</h2>
        </div>
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-0 lg:divide-x divide-gray-100 lg:min-h-[380px]">
            ...
            <div className="flex flex-col lg:px-4 xl:px-6 min-w-0">
              <div className="flex flex-col mb-1 justify-start">
                <span className="text-gray-700 text-sm font-semibold">{t('nuxio', 'ts_s1_name')}</span>
                <span className="text-gray-400 text-[10px] uppercase tracking-wide">{t('nuxio', 'ts_s1_week')}</span>
              </div>
              <div className="mt-3 lg:mt-4 relative flex items-center gap-2.5 bg-amber-50 rounded-2xl shadow-sm border border-amber-200 p-1.5 pr-3 w-full hover:-translate-y-1 transition-transform group">
                ...
                <div className="flex flex-col flex-1 min-w-0 justify-center">
                  <span className="text-gray-900 text-xs xl:text-sm font-semibold leading-tight truncate">{t('nuxio', 'ts_s1_title')}</span>
                  <span className="text-gray-500 text-[9px] xl:text-[10px] leading-tight mt-0.5 truncate">{t('nuxio', 'ts_s1_desc')}</span>
                </div>
            ...
            <div className="flex flex-col lg:px-4 xl:px-6 min-w-0">
              <div className="flex flex-col mb-1 justify-start">
                <span className="text-gray-700 text-sm font-semibold">{t('nuxio', 'ts_s2_name')}</span>
                <span className="text-gray-400 text-[10px] uppercase tracking-wide">{t('nuxio', 'ts_s2_week')}</span>
              </div>
              <div className="mt-3 lg:mt-24 relative flex items-center gap-2.5 bg-rose-50 rounded-2xl shadow-sm border border-rose-200 p-1.5 pr-3 w-full hover:-translate-y-1 transition-transform group">
                ...
                <div className="flex flex-col flex-1 min-w-0 justify-center">
                  <span className="text-gray-900 text-xs xl:text-sm font-semibold leading-tight truncate">{t('nuxio', 'ts_s2_title')}</span>
                  <span className="text-gray-500 text-[9px] xl:text-[10px] leading-tight mt-0.5 truncate">{t('nuxio', 'ts_s2_desc')}</span>
                </div>
            ...
            <div className="flex flex-col lg:px-4 xl:px-6 min-w-0">
              <div className="flex flex-col mb-1 justify-start">
                <span className="text-gray-700 text-sm font-semibold">{t('nuxio', 'ts_s3_name')}</span>
                <span className="text-gray-400 text-[10px] uppercase tracking-wide">{t('nuxio', 'ts_s3_week')}</span>
              </div>
              <div className="mt-3 lg:mt-48 relative flex items-center gap-2.5 bg-blue-50 rounded-2xl shadow-sm border border-blue-200 p-1.5 pr-3 w-full hover:-translate-y-1 transition-transform group">
                ...
                <div className="flex flex-col flex-1 min-w-0 justify-center">
                  <span className="text-gray-900 text-xs xl:text-sm font-semibold leading-tight truncate">{t('nuxio', 'ts_s3_title')}</span>
                  <span className="text-gray-500 text-[9px] xl:text-[10px] leading-tight mt-0.5 truncate">{t('nuxio', 'ts_s3_desc')}</span>
                </div>
            ...
            <div className="flex flex-col lg:pl-4 xl:pl-6 min-w-0">
              <div className="flex flex-col mb-1 justify-start">
                <span className="text-gray-700 text-sm font-semibold">{t('nuxio', 'ts_s4_name')}</span>
                <span className="text-gray-400 text-[10px] uppercase tracking-wide">{t('nuxio', 'ts_s4_week')}</span>
              </div>
              <div className="mt-3 lg:mt-[270px] relative flex items-center gap-2.5 bg-emerald-50 rounded-2xl shadow-sm border border-emerald-200 p-1.5 pr-3 w-full hover:-translate-y-1 transition-transform group">
                ...
                <div className="flex flex-col flex-1 min-w-0 justify-center">
                  <span className="text-gray-900 text-xs xl:text-sm font-semibold leading-tight truncate">{t('nuxio', 'ts_s4_title')}</span>
                  <span className="text-gray-500 text-[9px] xl:text-[10px] leading-tight mt-0.5 truncate">{t('nuxio', 'ts_s4_desc')}</span>
                </div>
        ...
        <div className="w-full bg-gray-50/50 px-6 md:px-10 py-6 border-t border-gray-100 flex flex-wrap items-center gap-4 lg:gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600 text-[10px] md:text-xs">{t('nuxio', 'ts_legend1')}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="size-2 bg-rose-500 rounded-full shrink-0" />
            <span className="text-gray-600 text-[10px] md:text-xs">{t('nuxio', 'ts_legend2')}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="size-2 bg-blue-500 rounded-full shrink-0" />
            <span className="text-gray-600 text-[10px] md:text-xs">{t('nuxio', 'ts_legend3')}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="size-2 bg-emerald-500 rounded-full shrink-0" />
            <span className="text-gray-600 text-[10px] md:text-xs">{t('nuxio', 'ts_legend4')}</span>
          </div>
        </div>
